...
// @rooute  PUT /api/v1/auth/updatedepassword
// @access  Private
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
	...
	if (!user) {
		return next(new ErrorResponse(`There is no user with such an email`, 404));
	}
...
// @desc    Reset password
// @rooute  PUT /api/v1/auth/resetpassword/:reset
// @access  Public
